...
parser.add_argument('--model_path', type=str, default='weights/cifar10-best-97.61.pt', help='path of pretrained model')
...
def main():
    ...
    _, test_transform = utils._data_transforms(args)
    if args.dataset == 'cifar10':
